...
There is a Golang utility in `bin/utility` that generates a complete config.json on demand from the existing defaults in the code. You can use it and modify the resulting JSON file as desired for your environment.
